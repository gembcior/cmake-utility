...
find_path(GNU_ARM_EMBEDDED_TOOLCHAIN
  ...
  PATHS
    ${STM32_TOOLCHAIN}
    $ENV{HOME}/tools/toolchains/gcc-arm-none-eabi-10.3-2021.07
)

set(CMAKE_C_COMPILER "${GNU_ARM_EMBEDDED_TOOLCHAIN}/bin/arm-none-eabi-gcc")
set(CMAKE_CXX_COMPILER "${GNU_ARM_EMBEDDED_TOOLCHAIN}/bin/arm-none-eabi-g++")
